...
export const TYPE_TO_ROLE: Partial<Record<string, Role>> = {
  ...
  // Marine/aquatic
  Pterosauria: 'striker', // was scout
  Ichthyosauria: 'support', // was specialist
  Plesiosauria: 'support', // was specialist
  Eurypterida: 'striker',
  ...
  Cimolesta: 'striker', // was scout
  Multituberculata: 'striker', // was scout
  Sirenia: 'support',
  Primates: 'support',
  Lagomorpha: 'striker', // was scout
  Rodentia: 'striker', // was scout

  // Reptiles/amphibians
  Squamata: 'striker', // was scout
  Reptilia: 'bruiser',
  Temnospondyli: 'support', // was specialist
  Urodela: 'support', // was specialist
  Anura: 'striker', // was scout

  // Placoderms/fish
  Phlyctaeniiformes: 'support', // was specialist
  Actinolepidiformes: 'support', // was specialist
  Bothriolepidiformes: 'support', // was specialist
  Asterolepidiformes: 'tank',

  // Trilobites
  Asaphida: 'tank',
  Phacopida: 'bruiser',
  Odontopleurida: 'support', // was specialist
  Corynexochida: 'bruiser',
  Trinucleida: 'support',
  Redlichiida: 'bruiser',

  // Birds
  Hesperornithiformes: 'support', // was specialist
  Ichthyornithes: 'striker', // was scout
  Anseriformes: 'support',
  Columbiformes: 'striker', // was scout
  Charadriiformes: 'striker', // was scout
  Galliformes: 'bruiser',
  Sphenisciformes: 'support', // was specialist
